...
game_stats.drop(columns=['Game_ID', 'GAME_DATE', 'MATCHUP', 'WL', 'FG_PCT', 'FG3_PCT', 'FT_PCT', 'VIDEO_AVAILABLE'], inplace=True)
...
stats.to_csv('all_player_stats_2025_2026.csv', index=False)
